...
describe("MBSwappedUInt32", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBSwappedUInt32(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      mbVariable = new MBSwappedUInt32(project, device);
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      variable = new MBSwappedUInt32(project, device);
    ...
    it("should not initialize any property and throw - if type is invalid", async () => {
      ...
      expect(error.message).toEqual(
        "Invalid type in payload of MBSwappedUInt32"
      );
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual(
        "Invalid length in payload of MBSwappedUInt32"
      );
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return MBSwappedUInt32.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [MBSwappedUInt32]`);
    });
    ...
    it("should return message if defaultValue is a greater than 4294967295", () => {
      payload.defaultValue = 4294967296;

      let result = exec();

      expect(result).toEqual(
        `"defaultValue" must be less than or equal to 4294967295`
      );
    });
