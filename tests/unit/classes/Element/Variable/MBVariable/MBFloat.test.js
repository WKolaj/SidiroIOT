...
describe("MBFloat", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBFloat(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      mbVariable = new MBFloat(project, device);
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      variable = new MBFloat(project, device);
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.DefaultValue).toBeCloseTo(123.456);
      expect(variable.SampleTime).toEqual(876);

      expect(variable.Value).toBeCloseTo(123.456);
    ...
    it("should not initialize any property and throw - if type is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid type in payload of MBFloat");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of MBFloat");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return MBFloat.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [MBFloat]`);
    });
