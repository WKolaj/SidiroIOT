...
describe("MBUInt16", () => {
  ...
  describe("validatePayload", () => {
    ...
    let exec = async () => {
      return MBUInt16.validatePayload(payload);
    };
    ...
    it("should return message if type is null", async () => {
      ...
      expect(result).toEqual(`"type" must be [MBUInt16]`);
    });
    ...
    it("should return message if defaultValue is a greater than 65535", async () => {
