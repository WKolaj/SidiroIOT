...
describe("MBSwappedDouble", () => {
  ...
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBSwappedDouble(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      mbVariable = new MBSwappedDouble(project, device);
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      variable = new MBSwappedDouble(project, device);
    ...
    it("should not initialize any property and throw - if type is invalid", async () => {
      ...
      expect(error.message).toEqual(
        "Invalid type in payload of MBSwappedDouble"
      );
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual(
        "Invalid length in payload of MBSwappedDouble"
      );
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return MBSwappedDouble.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [MBSwappedDouble]`);
    });
