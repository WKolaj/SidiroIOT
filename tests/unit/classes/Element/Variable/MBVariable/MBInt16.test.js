...
describe("MBInt16", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MBInt16(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      mbVariable = new MBInt16(project, device);
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      variable = new MBInt16(project, device);
    ...
    it("should not initialize any property and throw - if type is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid type in payload of MBInt16");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of MBInt16");
