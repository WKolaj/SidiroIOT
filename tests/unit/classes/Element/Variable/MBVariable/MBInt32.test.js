...
describe("MBInt32", () => {
  ...
  describe("init", () => {
    ...
    it("should not initialize any property and throw - if type is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid type in payload of MBInt32");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of MBInt32");
  ...
  describe("validatePayload", () => {
    ...
    let exec = async () => {
      return MBInt32.validatePayload(payload);
    };
    ...
    it("should return message if type is null", async () => {
      ...
      expect(result).toEqual(`"type" must be [MBInt32]`);
    });
    ...
    it("should return message if defaultValue is a smaller than -2147483648", async () => {
    ...
    it("should return message if defaultValue is a greater than 2147483647", async () => {
