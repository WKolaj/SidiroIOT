...
describe("S7SInt", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7SInt(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7SInt(project, device);
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7SInt");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of S7SInt");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7SInt.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7SInt]`);
    });
    ...
    it("should return message if defaultValue is a smaller than -128", () => {
      payload.defaultValue = -129;

      let result = exec();

      expect(result).toEqual(
        `"defaultValue" must be greater than or equal to -128`
      );
    });

    it("should return message if defaultValue is a greater than 127", () => {
      payload.defaultValue = 128;

      let result = exec();

      expect(result).toEqual(
        `"defaultValue" must be less than or equal to 127`
      );
    });
  ...
  describe("checkIfValueCanBeSet", () => {
    ...
    it("should return message if value is greater than 127", () => {
      value = 128;

      let result = exec();

      expect(result).toEqual(`"value" must be less than or equal to 127`);
    });

    it("should return message if value is sammler than -128", () => {
      value = -129;

      let result = exec();

      expect(result).toEqual(`"value" must be greater than or equal to -128`);
    });
