...
describe("S7Real", () => {
  ...
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7Real(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7Real(project, device);
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7Real");
      expect(variable.DefaultValue).toEqual(123.321);
      expect(variable.SampleTime).toEqual(876);

      expect(variable.Value).toBeCloseTo(123.321);
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of S7Real");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7Real.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7Real]`);
    });
