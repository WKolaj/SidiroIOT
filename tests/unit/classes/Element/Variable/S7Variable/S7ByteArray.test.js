...
describe("S7ByteArray", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7ByteArray(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7ByteArray(project, device);

      return variable._convertDataToValue(data);
    };

    it("should return proper value - the same array", async () => {
      let result = await exec();

      expect(result).toEqual([1, 2, 3, 4]);
    });

    it("should return proper value - if data is empty array", async () => {
      data = [];
      let result = await exec();
  ...
  describe("_convertValueToData", () => {
    ...
    it("should return proper data - the same array", async () => {
      let result = await exec();

      expect(result).toEqual([1, 2, 3, 4]);
    });

    it("should return proper data - if value is empty array", async () => {
      value = [];
      let result = await exec();
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7ByteArray");
      expect(variable.DefaultValue).toEqual([1, 2, 3, 4]);
    ...
    it("should not initialize any property and throw - if length is invalid, not the same as value length", async () => {
      payload.length = 5;
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7ByteArray.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7ByteArray]`);
    });
    ...
    it("should return message if defaultValue is longer than length of variable", () => {
      payload.defaultValue = [1, 2, 3, 4, 5];
      payload.length = 4;
    ...
    it("should return message if defaultValue is shorter than length of variable", () => {
      payload.defaultValue = [1, 2, 3];
      payload.length = 4;
    ...
    it("should return message if defaultValue has values greater than 255", () => {
      payload.defaultValue = [256, 2, 3, 4];
      payload.length = 4;
  ...
  describe("checkIfValueCanBeSet", () => {
    ...
    it("should return message if value and length is invalid", () => {
      ...
      expect(result).toEqual(`"value" must contain 4 items`);
    });
