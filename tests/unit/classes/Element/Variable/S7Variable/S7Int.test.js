...
describe("S7Int", () => {
  ...
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7Int(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7Int(project, device);
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7Int");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of S7Int");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7Int.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7Int]`);
    });
  ...
  describe("checkIfValueCanBeSet", () => {
    ...
    it("should return message if value is greater than 32767", () => {
      value = 32768;

      let result = exec();

      expect(result).toEqual(`"value" must be less than or equal to 32767`);
    });

    it("should return message if value is sammler than -32768", () => {
      value = -32769;

      let result = exec();

      expect(result).toEqual(`"value" must be greater than or equal to -32768`);
    });
