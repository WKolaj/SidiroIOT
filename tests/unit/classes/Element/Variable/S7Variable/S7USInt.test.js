...
describe("S7USInt", () => {
  ...
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7USInt(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7USInt(project, device);
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7USInt");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of S7USInt");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7USInt.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7USInt]`);
    });
    ...
    it("should return message if defaultValue is a greater than 255", () => {
      payload.defaultValue = 256;

      let result = exec();

      expect(result).toEqual(
        `"defaultValue" must be less than or equal to 255`
      );
    });
  ...
  describe("checkIfValueCanBeSet", () => {
    ...
    it("should return message if value is greater than 255", () => {
      value = 256;

      let result = exec();

      expect(result).toEqual(`"value" must be less than or equal to 255`);
    });
