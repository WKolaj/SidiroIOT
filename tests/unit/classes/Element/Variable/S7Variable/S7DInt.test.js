...
describe("S7DInt", () => {
  describe("constructor", () => {
    ...
    let exec = () => {
      return new S7DInt(project, device);
    };
  ...
  describe("_convertDataToValue", () => {
    ...
    let exec = async () => {
      variable = new S7DInt(project, device);
  ...
  describe("init", () => {
    ...
    it("should initialize variable's properties based on their payload", async () => {
      ...
      expect(variable.Type).toEqual("S7DInt");
    ...
    it("should not initialize any property and throw - if length is invalid", async () => {
      ...
      expect(error.message).toEqual("Invalid length in payload of S7DInt");
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return S7DInt.validatePayload(payload);
    };
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [S7DInt]`);
    });
