...
describe("MaxCalculator", () => {
  ...
  describe("constructor", () => {
    ...
    let exec = () => {
      return new MaxCalculator(project, device);
    };

    it("should create new MaxCalculator and set all its properties to null", () => {
      let result = exec();
  ...
  describe("init", () => {
    ...
    let exec = async () => {
      ...
      calcElement = new MaxCalculator(project, device);

      return calcElement.init(payload);
    };

    it("should initialized MaxCalculator based on its payload", async () => {
      await exec();
  ...
  describe("generatePayload", () => {
    ...
    it("should return a valid MaxCalculator payload", async () => {
  ...
  describe("validatePayload", () => {
    ...
    let exec = () => {
      return MaxCalculator.validatePayload(payload);
    };

    it("should return null if MaxCalculator payload is valid", async () => {
      let result = exec();
    ...
    it("should return message if type is null", () => {
      ...
      expect(result).toEqual(`"type" must be [MaxCalculator]`);
    });
  ...
  describe("checkIfValueCanBeSet", () => {
    ...
    it("should always return a message that MaxCalculator is read only", async () => {
      let result = await exec();

      expect(result).toEqual("MaxCalculator value is readonly");
    });
  });
  ...
  describe("refresh", () => {
    ...
    it("should set new value and tickId to calcElement - if value is greater then actual value", async () => {
      await exec();
    ...
    it("should not set new value and tickId to calcElement - if value is smaller then actual value", async () => {
      variable1Value = 9.9;
    ...
    it("should begin new interval and set value to calcElement - if value is greater then actual and tick id is from new interval", async () => {
      variable1Value = 10.1;
      variable1LastValueTick = 201;
    ...
    it("should begin new interval, skip one internval and set value to calcElement - if value is smaller then actual but tick id is from new interval more than one interval ahead", async () => {
      variable1Value = 9.9;
    ...
    it("should begin new interval, skip one internval and set value to calcElement - if value is greater then actual and tick id is from new interval more than one interval ahead", async () => {
      variable1Value = 10.1;
      variable1LastValueTick = 301;
    ...
    it("should set value to calcElement and new beginIntervalTick and endInterval tick - if refreshedFirstTime is false, value is smaller and interval values are null", async () => {
    ...
    it("should set value to calcElement and new beginIntervalTick and endInterval tick - if refreshedFirstTime is false, value is greatrer and interval values are null", async () => {
      refreshedFirstTime = false;
      beginIntervalTick = null;
      endIntervalTick = null;
      value = 11;
