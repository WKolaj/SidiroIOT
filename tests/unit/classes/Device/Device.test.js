...
describe("Device", () => {
  ...
  describe("Elements", () => {
    ...
    it("should return an array of all variables, calcElements and alerts", async () => {
      ...
      let expectedResult = {
        ...
        [calcElement1.ID]: calcElement1,
        [calcElement2.ID]: calcElement2,
        [calcElement3.ID]: calcElement3,
        [alert1.ID]: alert1,
        [alert2.ID]: alert2,
        [alert3.ID]: alert3,
      };
    ...
    it("should return an array of all variables, calcElements and alerts - if there are no variables", async () => {
    ...
    it("should return an array of all variables, calcElements and alerts - if there are no calcElements", async () => {
    ...
    it("should return an array of all variables, calcElements and alerts - if there are no elements", async () => {
      createAlerts = false;
      createVariables = false;
      createCalcElements = false;
