...
describe("api/calcElement", () => {
  ...
  describe("GET/", () => {
    ...
    it("should return 200 and payload of all calcElements", async () => {
      ...
      for (let device of Object.values(devices))
        for (let calcElement of Object.values(device.CalcElements))
          expectedPayload[calcElement.ID] = calcElement.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of all calcElements from given device if deviceId is presented in payload - if device is connectableDevice", async () => {
      deviceId = "connectableDeviceID2";
      let result = await exec();
      ...
      for (let calcElement of Object.values(devices[deviceId].CalcElements))
        expectedPayload[calcElement.ID] = calcElement.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of all calcElements from given device if deviceId is presented in payload - if device is internalDevice", async () => {
    ...
    it("should return 200 and payload of all calcElements from given device if deviceId is presented in payload - if device is agentDevice", async () => {
  ...
  describe("GET/:id", () => {
    ...
    let exec = async () => {
      ...
      let apiPath = `/api/calcElement/${calcElementId}`;
    ...
    it("should return 200 and payload of given calcElement - if device is connectableDevice", async () => {
      calcElementId = "connectableDeviceID2CalcElement2ID";
      ...
      let calcElement = projectService.getCalcElement(
        "connectableDeviceID2",
        "connectableDeviceID2CalcElement2ID"
      );

      let expectedPayload = calcElement.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of given calcElement - if device is internalDevice", async () => {
    ...
    it("should return 200 and payload of given calcElement - if device is agentDevice", async () => {
    ...
    it("should return 200 and payload of given calcElement - if device is connectableDevice - if deviceId filter exists, device exists and has given calcElement", async () => {
      deviceId = "connectableDeviceID2";
      calcElementId = "connectableDeviceID2CalcElement2ID";
    ...
    it("should return 200 and payload of given calcElement - if device is internalDevice - if deviceId filter exists, device exists and has given calcElement", async () => {
      deviceId = "internalDeviceID2";
      calcElementId = "internalDeviceID2CalcElement2ID";
    ...
    it("should return 200 and payload of given calcElement - if device is agentDevice - if deviceId filter exists, device exists and has given calcElement", async () => {
      deviceId = "agentDeviceID1";
      calcElementId = "agentDeviceID1CalcElement2ID";
    ...
    it("should return 404 - if device is connectableDevice - if deviceId filter exists, but device does not exist and calcElement exists", async () => {
      deviceId = "fakeDeviceID2";
      calcElementId = "connectableDeviceID2CalcElement2ID";
      ...
      expect(result.text).toEqual("CalcElement not found");
    });

    it("should return 404 - if device is internalDevice - if deviceId filter exists, but device does not exist and calcElement exists", async () => {
      deviceId = "fakeDeviceID2";
      calcElementId = "internalDeviceID2CalcElement2ID";
    ...
    it("should return 404 - if device is agentDevice - if deviceId filter exists, but device does not exist and calcElement exists", async () => {
      deviceId = "fakeDeviceID2";
      calcElementId = "agentDeviceID1CalcElement2ID";
    ...
    it("should return 404 - if device is connectableDevice - if deviceId filter exists, but device exist but calcElement does not exist", async () => {
      deviceId = "connectableDeviceID2";
      calcElementId = "fakeCalcElement2ID";
    ...
    it("should return 404 - if device is internalDevice - if deviceId filter exists, but device exist but calcElement does not exist", async () => {
      deviceId = "internalDeviceID2";
      calcElementId = "fakeCalcElement2ID";
    ...
    it("should return 404 - if device is agentDevice - if deviceId filter exists, but device exist but calcElement does not exist", async () => {
      deviceId = "agentDeviceID1";
      calcElementId = "fakeCalcElement2ID";
    ...
    it("should return 404 - if device is internalDevice - if deviceId filter exists, but device does not exist and calcElement does not exist", async () => {
