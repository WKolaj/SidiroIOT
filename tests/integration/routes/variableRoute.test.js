...
describe("api/variable", () => {
  ...
  describe("GET/", () => {
    ...
    it("should return 200 and payload of all variables from given device if deviceId is presented in payload - if device is connectableDevice", async () => {
    ...
    it("should return 200 and payload of all variables from given device if deviceId is presented in payload - if device is internalDevice", async () => {
  ...
  describe("GET/:id", () => {
    ...
    let exec = async () => {
      ...
      let apiPath = `/api/variable/${variableId}`;
    ...
    it("should return 200 and payload of given variable - if device is internalDevice", async () => {
      variableId = "internalDeviceID2Variable2ID";
    ...
    it("should return 200 and payload of given variable - if device is connectableDevice - if deviceId filter exists, device exists and has given variable", async () => {
      deviceId = "connectableDeviceID2";
      variableId = "connectableDeviceID2Variable2ID";
    ...
    it("should return 200 and payload of given variable - if device is internalDevice - if deviceId filter exists, device exists and has given variable", async () => {
      deviceId = "internalDeviceID2";
      variableId = "internalDeviceID2Variable2ID";
