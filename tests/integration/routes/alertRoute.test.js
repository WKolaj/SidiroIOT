...
describe("api/calcElement", () => {
  ...
  describe("GET/", () => {
    ...
    it("should return 200 and payload of all alerts", async () => {
      ...
      for (let device of Object.values(devices))
        for (let alert of Object.values(device.Alerts))
          expectedPayload[alert.ID] = alert.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of all alerts from given device if deviceId is presented in payload - if device is connectableDevice", async () => {
      deviceId = "connectableDeviceID2";
      let result = await exec();
      ...
      for (let alert of Object.values(devices[deviceId].Alerts))
        expectedPayload[alert.ID] = alert.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of all alerts from given device if deviceId is presented in payload - if device is internalDevice", async () => {
    ...
    it("should return 200 and payload of all alerts from given device if deviceId is presented in payload - if device is agentDevice", async () => {
  ...
  describe("GET/:id", () => {
    ...
    it("should return 200 and payload of given alert - if device is connectableDevice", async () => {
      alertId = "connectableDeviceID2Alert2ID";
      ...
      let alert = projectService.getAlert(
        "connectableDeviceID2",
        "connectableDeviceID2Alert2ID"
      );

      let expectedPayload = alert.generatePayload();

      expect(result.body).toEqual(expectedPayload);
    });

    it("should return 200 and payload of given alert - if device is internalDevice", async () => {
    ...
    it("should return 200 and payload of given alert - if device is agentDevice", async () => {
    ...
    it("should return 200 and payload of given alert - if device is connectableDevice - if deviceId filter exists, device exists and has given alert", async () => {
      deviceId = "connectableDeviceID2";
      alertId = "connectableDeviceID2Alert2ID";
    ...
    it("should return 200 and payload of given alert - if device is internalDevice - if deviceId filter exists, device exists and has given alert", async () => {
      deviceId = "internalDeviceID2";
      alertId = "internalDeviceID2Alert2ID";
    ...
    it("should return 200 and payload of given alert - if device is agentDevice - if deviceId filter exists, device exists and has given alert", async () => {
      deviceId = "agentDeviceID1";
      alertId = "agentDeviceID1Alert2ID";
    ...
    it("should return 404 - if device is connectableDevice - if deviceId filter exists, but device does not exist and alert exists", async () => {
      deviceId = "fakeDeviceID2";
      alertId = "connectableDeviceID2Alert2ID";
      ...
      expect(result.text).toEqual("Alert not found");
    });

    it("should return 404 - if device is internalDevice - if deviceId filter exists, but device does not exist and alert exists", async () => {
      deviceId = "fakeDeviceID2";
      alertId = "internalDeviceID2Alert2ID";
    ...
    it("should return 404 - if device is agentDevice - if deviceId filter exists, but device does not exist and alert exists", async () => {
      deviceId = "fakeDeviceID2";
      alertId = "agentDeviceID1Alert2ID";
    ...
    it("should return 404 - if device is connectableDevice - if deviceId filter exists, but device exist but alert does not exist", async () => {
      deviceId = "connectableDeviceID2";
      alertId = "fakeAlert2ID";
    ...
    it("should return 404 - if device is internalDevice - if deviceId filter exists, but device exist but alert does not exist", async () => {
      deviceId = "internalDeviceID2";
      alertId = "fakeAlert2ID";
    ...
    it("should return 404 - if device is agentDevice - if deviceId filter exists, but device exist but alert does not exist", async () => {
      deviceId = "agentDeviceID1";
      alertId = "fakeAlert2ID";
    ...
    it("should return 404 - if deviceId filter exists, but device does not exist and alert does not exist", async () => {
