...
const {
  joiSchema,
} = require("../../../../models/Elements/CalcElements/ExtremeCalculator/MaxCalculator");

class MaxCalculator extends ExtremeCalculator {
  //#region ========= CONSTRUCTOR =========
  ...
  /**
   * @description Method for checking if new value is an extreme or not. In case of max value - checking if new value is greater than actual one
  ...
  checkIfValueCanBeSet(value) {
    return "MaxCalculator value is readonly";
  }

  //#endregion ========= OVERRIDE PUBLIC METHODS =========
}

module.exports = MaxCalculator;
