...
const { joiSchema } = require("../../../models/Elements/Alerts/HighLimitAlert");
const { exists } = require("../../../utilities/utilities");

const defaultHighAlertTranslationObject = {
  pl: "Przekroczenie granicy alarmowej: $VALUE",
  en: "High limit alert: $VALUE",
};

class HighLimitAlert extends Alert {
  //#region ========= CONSTRUCTOR =========
  ...
  async init(payload) {
    ...
    this._texts = exists(payload.texts)
      ? payload.texts
      : defaultHighAlertTranslationObject;
  ...
  checkIfValueCanBeSet(value) {
    return "HighLimitAlert value is readonly";
  }
