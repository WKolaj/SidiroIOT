...
class MBSwappedUInt32 extends MBVariable {
   ...
   */
  async init(payload) {
    if (payload.type !== "MBSwappedUInt32")
      throw new Error("Invalid type in payload of MBSwappedUInt32");
    if (payload.length !== 2)
      throw new Error("Invalid length in payload of MBSwappedUInt32");
