...
const {
  joiSchema,
} = require("../../../../../models/Elements/Variable/MBVariable/MBSwappedFloat");
...
class MBSwappedFloat extends MBVariable {
   ...
   */
  async init(payload) {
    if (payload.type !== "MBSwappedFloat")
      throw new Error("Invalid type in payload of MBSwappedFloat");
    if (payload.length !== 2)
